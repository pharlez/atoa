...
STATIC_ROOT = '/home/thalis/neerbee'
...
ROOT_URLCONF = 'atasteofathens.urls'
...
# Settings for number of days allowed for account to be activated
# Also mail server settings
